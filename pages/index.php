                ...
                <form role="form" action="index.php" method="post">
                    ...
                    <center>
                        <div class="row">
                            ...
                            <div class="col-md-2 col-xs-4"><input name="5pddt" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="5pdpc" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>36# PD</div></div>
                            <div class="col-md-2 col-xs-4"><input name="36pdpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="36pddt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>50# PD</div></div>
                            <div class="col-md-2 col-xs-4"><input name="50pdpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="50pddt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>1000# PD</div></div>
                            <div class="col-md-2 col-xs-4"><input name="1000pdpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="1000pddt" type="number" class="form-control" placeholder="0"></div>
                        </div>     
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>2000# PD</div></div>
                            <div class="col-md-2 col-xs-4"><input name="2000pdpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="2000pddt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>50# PD GG</div></div>
                            <div class="col-md-2 col-xs-4"><input name="50pdggpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="50pdggdt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>1000# PD GG</div></div>
                            <div class="col-md-2 col-xs-4"><input name="1000pdggpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="100pdggdt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>2000# PD GG</div></div>
                            <div class="col-md-2 col-xs-4"><input name="2000pdggpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="200pdggdt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>36# California</div></div>
                            <div class="col-md-2 col-xs-4"><input name="36calipc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="36calidt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>36# Maryland</div></div>
                            <div class="col-md-2 col-xs-4"><input name="36marypc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="36marydt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>36# Canada</div></div>
                            <div class="col-md-2 col-xs-4"><input name="36canpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="36candt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>50# Canada</div></div>
                            <div class="col-md-2 col-xs-4"><input name="50canpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="50candt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-1 col-xs-4"><div class="Product"><br>1T Canada</div></div>
                            <div class="col-md-2 col-xs-4"><input name="1tcanpc" type="number" class="form-control" placeholder="0"></div>
                            <div class="col-md-2 col-xs-4"><input name="1tcandt" type="number" class="form-control" placeholder="0"></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-1 col-xs-3">
                                ...
                                <input name="dt" type="number" class="form-control" placeholder="0">
                            </div>

                            <div class="form-group col-md-1 col-xs-3">
                                <label>Prod. Time</label>
                                <input name="tpt" type="number" class="form-control" placeholder="0">
                            </div>
